...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        public float shiftThrustMultiplier = 4f;
        [Tooltip("Pitch, Yaw, Roll")] public Vector3 turnTorque = new Vector3(90f, 25f, 45f);
        [Tooltip("turnTorque when Shifted")] public Vector3 shiftedTurnTorque = new Vector3(45f, 45f, 45f);
        ...
        private void Update()
        {
            ...
            float autoRoll = 0f;
            if (aimPos != null)
                RunAutopilot(aimPos, out autoYaw, out autoPitch, out autoRoll);
        ...
        public void SetAimPos(Vector3 flyTarget)
        {
            aimPos = flyTarget;
        }
        ...
        private void FixedUpdate()
        {
            ...
            var vectorThrust = forceMult * thrust * Vector3.forward;
            var vectorTurn = new Vector3(turnTorque.x * pitch,
                                                turnTorque.y * yaw,
                                                -turnTorque.z * roll) * forceMult;

            if (isShifted)
            {
                vectorThrust *= shiftThrustMultiplier;
                vectorTurn = new Vector3(shiftedTurnTorque.x * pitch,
                                                shiftedTurnTorque.y * yaw,
                                                -shiftedTurnTorque.z * roll) * forceMult;
            }

            rigid.AddRelativeForce(vectorThrust, ForceMode.Force);

            rigid.AddRelativeTorque(vectorTurn,
                                    ForceMode.Force);
        }
    }
}
